...
public class CardatabaseApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user = new User("user", "$2a$10$HLQhymbKzHuznpKX4qNpFuSPDEIZZqQIVUS9M5SnVpQCnScZSgAgK", "USER");
			User admin = new User("admin", "$2a$10$52uRlXENwkZjt2CjJxk1r.tw5pf5lJlt2sW8CX8k2abwB5.yhD85e", "ADMIN");

			userRepository.save(user);
			userRepository.save(admin);

			Owner owner1 = new Owner("John", "Müller");
			Owner owner2 = new Owner("Otto", "Meier");
